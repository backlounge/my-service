...
const SECTIONS = [
  ...
  },
  {
    ...
    body:
      "広告事業者や第三者のアクセス解析ツールによるCookieは使用していません。一方で、サイト改善と申込導線の確認のため、当サイト独自のアクセス解析を行っています。ブラウザのsessionStorageに、そのブラウザを識別するランダムなIDを一時保存し、閲覧ページ、参照元ドメイン、UTMパラメータ、イベント種別、日時をCloudflare D1へ記録します。IPアドレス、氏名、メールアドレス、フォーム本文はこの解析データに記録しません。解析データは最長3年間保存し、サイト改善および集客施策の効果確認にのみ利用します。",
  },
  {
